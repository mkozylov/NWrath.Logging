...
{
    [TestFixture]
    public class ThreadSaveLoggerTests
    {
        [Test]
        public void ThreadSaveLogger_OptionsPropagation()
        {
            ...
            var saveLogger = new ThreadSaveLogger(loggerMock.Object);
        ...
        [Test]
        public void ThreadSaveLogger_SaveMultiThreadLog()
        {
            var messages = new List<string>();

            var logger = new LambdaLogger(m => { messages.Add(m.Message); });

            var saveLogger = new ThreadSaveLogger(logger);
        ...
        [Test]
        public void ThreadSaveLogger_NotSaveMultiThreadLog()
        {
            var messages = new List<string>();
